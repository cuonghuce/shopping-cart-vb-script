...
' trang hien tai
    ...
    strSQL = "SELECT COUNT(MaHoaDB) AS count FROM tbl_HoaDonBan where SoLuong  Like '%"&inputsearch&"%' "
	...
	currentUrl = "hoadonban.asp?input-search="&inputsearch&"&"
								...
								<table class="table table-striped table-hover">
									...
									<tbody>
										...
										Set cmdPrep = Server.CreateObject("ADODB.Command")
											...
											cmdPrep.CommandText = "SELECT * FROM tbl_HoaDonBan where SoLuong Like '%"&inputsearch&"%' ORDER BY MaHoaDB OFFSET ? ROWS FETCH NEXT ? ROWS ONLY"
										...
										<tr>
											...
											<td style="display:flex;">
												<a style="width: 40px;height: 40px;" href="chitietSP.asp?id=<%=Curr("MaHoaDB")%>" class="btn btn-primary mr-2 "><i style="color: #fff;margin-top:8px;" class="fa-solid fa-eye"></i></a>
											</td>
